...
public class UserModiAndDelIFrame extends JInternalFrame {
	...
	private Object[][] getFileStates(List list) {
		String[] str = { "用户编号", "姓名", "性别", "年龄", "注册日期", "联系电话", "密码" };
	...
	public UserModiAndDelIFrame() {
		...
		str = new String[] { "用户编号", "姓名", "性别", "年龄", "注册日期", "联系电话", "密码" };
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseClicked(final MouseEvent e) {
				String idd, name, sex, age, workdate, tel, password;
				...
				workdate = table.getValueAt(selRow, 4).toString().trim();
		...
		panel_2.setPreferredSize(new Dimension(300, 180));
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				int i = Dao.Updateuser(id, name, sex, age, java.sql.Date.valueOf(date), tel, password);
				if (i == 1) {
