...
public class UserAddIFrame extends JInternalFrame {
	...
	public UserAddIFrame() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (arg0.getSource() == button) {
					...
					if (textField.getText().length() > 12) {
						JOptionPane.showMessageDialog(null, "管理员姓名不能大于12位！");
						return;
					}
					...
					int admin = 1;
					int i = Dao.Insertoperator(username, sex, age, identityCard, java.sql.Date.valueOf(date), tel,
							password, admin);
					if (i == 1) {
		...
		panel_2.setPreferredSize(new Dimension(280, 220));
		panel_1.add(panel_2);
