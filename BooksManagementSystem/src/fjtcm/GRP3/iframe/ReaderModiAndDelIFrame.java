...
public class ReaderModiAndDelIFrame extends JInternalFrame {
	...
	private String[] columnNames = { "读者名称", "读者性别", "读者年龄", "证件号码", "会员证有效日期", "最大借书量", "电话", "押金", "证件", "职业",
			"借阅图书号", "读者办证时间" };
	...
	public ReaderModiAndDelIFrame() {
		...
		ImageIcon readerModiAndDelIcon = CreateIcon.add("readerModiAndDel.jpg");
		...
		panel_2.setPreferredSize(new Dimension(0, 220));
	...
	class ModiButtonListener implements ActionListener {
		...
		public void actionPerformed(final ActionEvent e) {
			...
			int i = Dao.UpdateReader(id, readername.getText().trim(), sex, age.getText().trim(),
